# This is a Python script that generates synthetic images and masks for a dataset using various image augmentation techniques. 
# multiprocessing library used for parallel processing to speed up the process.
...
# get_random_size: generates a random size for the output images.
...
# get_random_crop: generates a random crop for the output images.   
...
# creates a new image by combining a background image with a foreground image.
...
# generate_perspective_transformed_image: generates a perspective-transformed image and mask.
...
# operation: the main function that performs the image augmentation and generation.
def operation(params=None):
    ...
    motion_blur = A.MotionBlur(blur_limit=17, p=0.35)
    ...
    elastic_aug = A.ElasticTransform(alpha=150, sigma=13, alpha_affine=None, interpolation=0, border_mode=0, value=value, mask_value=0, p=0.9)
    ...
    perspective_transformer = T.RandomPerspective(distortion_scale=distortion_scale, p=0.1, interpolation=T.InterpolationMode.NEAREST)
...
# The script then defines the chunk function, which divides the input images and masks into chunks of a specified size.
def chunk(length, n):
...
if __name__ == "__main__":
    ...
    DOC_IMG_PATH = "/home/arjun123/PIXL/Augmentation/LabourCard/resized_images"
    DOC_MSK_PATH = "/home/arjun123/PIXL/Augmentation/LabourCard/resized_masks"

    GEN_IMG_DIR = "/home/arjun123/PIXL/Augmentation/LabourCard/final_set/images"
    GEN_MSK_DIR = "/home/arjun123/PIXL/Augmentation/LabourCard/final_set/masks"

    BCK_IMGS_DIR = "/home/arjun123/PIXL/Augmentation/LabourCard/background_images"
